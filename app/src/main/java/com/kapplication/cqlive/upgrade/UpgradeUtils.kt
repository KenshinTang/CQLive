package com.kapplication.cqlive.upgrade
...
import com.kapplication.cqlive.BuildConfig
...
class UpgradeUtils {
    ...
    companion object {
        ...
        private const val TEMP_FILE = "/CQLive/CQLive_TEMP.apk"
    ...
    fun startCheckUpgrade(okHttpClient: OkHttpClient) {
        ...
        val urlBuilder = HttpUrl.parse(Utils.HOST)!!.newBuilder()
                ...
                .addQueryParameter("c", "TerminalVersion")
                .addQueryParameter("a", "checkUpdate")
...
//                    XulLog.json(NAME, result)
                    ...
                    if (!handleError(dataNode)) {
                        mAPKUrl = dataNode.getChildNode("data").getAttributeValue("url")
